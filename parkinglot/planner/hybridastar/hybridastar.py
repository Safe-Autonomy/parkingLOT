...
based on: https://github.com/AtsushiSakai/PythonRobotics/blob/master/PathPlanning/HybridAStar/hybrid_a_star.py
"""
...
from heuristic import calc_distance_heuristic
# import heuristic.calc_distance_heuristic
...
def main():
	...
	start = [-34.494, -11.648, -3.1291]
	goal = [-43.741, -2.935, 2.207]
